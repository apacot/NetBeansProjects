...
{
    var adresse = $("#zoneTexte").val();
    if (adresse.length==0)
    {
        $("#zoneTexte").attr("placeholder","Il faut une adresse");
    }
    else
    {
    console.log(encodeURI(adresse));
...
$(document).ready(function () {
    ...
    // au click sur l'élément ayant pour id "adresse", faire appel à la fonction geolocalisation
    $("#adresse").click(geolocalisationv2);
});
