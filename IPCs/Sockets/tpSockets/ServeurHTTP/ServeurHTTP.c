...
int main(int argc, char** argv) {
    ...
    int retour;
    int tailleClient;
    char donneeRecue[TAILLEMAX] = {0};
    char donneeAEnvoyer[TAILLEMAX] = {0};
