...
int main(int argc, char** argv) 
{
    ...
    //afficher la donnee
    printf("message du client %s : %s %d/%d/%d \n", inet_ntoa(infosClient.sin_addr), donneeRecue.jourDeLaSemaine,(int)donneeRecue.jour, (int)donneeRecue.mois, (int)donneeRecue.annee);

/* !PAS DE RENVOI DU SERVEUR!    
